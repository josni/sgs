...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Tabela Copiada</h6>'+
				'<p>Copiado '+lines+' linha'+plural+' para a área de transferência.</p>',
				3000
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Visualização de Impressão</h6><p>Por favor, use a função de impressão do seu navegador para "+
		  "imprimir esta tabela. Pressione esc para sair.</p>",
		"sMessage": null,
		"bShowAll": true,
