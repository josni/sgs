...
<link rel="stylesheet" type="text/css" href="../../assets/media/css/tableTools.css">
    ...
    <script type="text/javascript" language="javascript" src="//cdn.datatables.net/responsive/1.0.6/js/dataTables.responsive.min.js"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        table.columns().every( function () {
           ...
           <h4 class="alert alert-success">Listagem de não sócios</h4>
