...
$table = "nao_socio";
$join = "inner join pessoa on nao_socio.id_pessoa_nao_socio = pessoa.id_pessoa inner join cidade on pessoa.id_cidade_pessoa = cidade.id_cidade inner join estado on cidade.id_estado_cidade = estado.id_estado";
