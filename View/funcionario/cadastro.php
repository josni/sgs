...
<form name="form_funcionario" action="/sgs/Controller/funcionario.controller.php" method="post">
    <div style="padding-top: 50px">
        <h2 style="text-align:center;" class="alert alert-success">Cadastro de Funcionário</h2>
        ...
        <div id="content" style="max-width: 500px; padding: 19px 29px 29px; margin: 60px auto 20px; background-color: #FFFFFF; border: 1px solid #E5E5E5;">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="inicio">
                    ...
                    <input type="text" name="senha" class="input-block-level" placeholder="Senha" required/><br />
                    <?php }?>
                   Administrador:<input type="checkbox" name="admin" class="input-block-level" />
                    ...
                    <input type="text" name="dt_entrada" class="input-block-level" value="<?php echo date('d/m/Y');?>" placeholder="Data Entrada" required/><br />
                    <?php 
                            if($operacao == 'EDITAR'){?>
                    <label class="control-label">Data de Saida:</label>
                    <input type="date" name="dt_saida" class="input-block-level" /><br />
                    <?php }?>
                ...
                <div class="tab-pane" id="documento">
                    ...
                    <input type="text" name="cpf" class="input-block-level cpf" id="cpf" placeholder="CPF" required/><br />
                ...
                <div class="tab-pane" id="email">
                    ...
                    <input type="submit" value="Cadastrar" id="btnFuncionario" class="btn btn-primary">
...
<script>
    with(document.form_funcionario){
        ...
        STATUS.checked = '<?php echo $listaFuncionario[0]['status_pessoa']; ?>';
        admin.checked = '<?php echo $listaFuncionario[0]['admin']; ?>';
        ...
        dt_entrada.value = '<?php echo $listaFuncionario[0]['dt_entrada']; ?>';
